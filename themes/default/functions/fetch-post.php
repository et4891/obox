...
<div class="post-content clearfix">
    ...
    <?php if(get_option('fb_comments') !='false' && comments_open()) : ?>
		<div class="fb-comments" data-href="<?php the_permalink(); ?>" data-width="600" data-numposts="5" data-colorscheme="light"></div>
    <?php else : 
		comments_template();
		endif; ?>
